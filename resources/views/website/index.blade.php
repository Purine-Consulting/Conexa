...
<head>
    ...
    =============================================
    -->
	<title>CONEXA | For a Brigther Future</title>
	<!--  
    Favicons
    =============================================
    -->

	<link rel="apple-touch-icon" sizes="180x180" href="assets/images/favicons/logo.ico">
	<link rel="icon" type="image/png" sizes="16x16" href="assets/images/favicons/logo.ico">
	...
	<main>
		...
		<nav class="navbar navbar-custom navbar-fixed-top navbar-transparent" role="navigation">
			<div class="container">
				<div class="navbar-header">
					<button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index.html"><img src="assets/images/logo.png" alt="logo"></a>
				</div>
				<div class="collapse navbar-collapse" id="custom-collapse">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="index_mp_fullscreen_video_background.html">Qui sommes-nous?</a></li>
						<li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Service</a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="#" data-toggle="modal" data-target="#menteeFormModal"><i class="fa fa-user-shield"></i>Trouve un mentor</a></li>
							</ul>
						</li>
		...
		<section class="home-section home-parallax home-fade home-full-height" id="home">
			<div class="hero-slider">
				<ul class="slides">
					<li class="bg-dark-30 bg-dark" style="background-image:url('https://images.pexels.com/photos/935949/pexels-photo-935949.jpeg?crop=entropy&cs=srgb&dl=pexels-nappy-935949.jpg&fit=crop&fm=jpg&w=1920')">
						<div class="titan-caption">
							<div class="caption-content">
								<div class="font-alt mb-40 titan-title-size-3">Ensemble pour un avenir meilleur</div>
								<a class="section-scroll btn btn-border-w btn-round" href="#" data-toggle="modal" data-target="#menteeFormModal">Inscrivez-vous</a>
							</div>
						</div>
					</li>
					<li class="bg-dark-30 bg-dark" style="background-image:url('https://images.pexels.com/photos/4427967/pexels-photo-4427967.jpeg?crop=entropy&cs=srgb&dl=pexels-august-de-richelieu-4427967.jpg&fit=crop&fm=jpg&w=1920');">
						<div class="titan-caption">
							<div class="caption-content">
								<div class="font-alt mb-30 titan-title-size-3">CONEXA</br>Votre plateforme de mentorat et de conseil</div>
								<a class="btn btn-border-w btn-round" href="#" data-toggle="modal" data-target="#menteeFormModal">Inscrivez-vous</a>
							</div>
						</div>
					</li>
					<li class="bg-dark-30 bg-dark" style="background-image:url('https://images.pexels.com/photos/5905483/pexels-photo-5905483.jpeg?crop=entropy&cs=srgb&dl=pexels-katerina-holmes-5905483.jpg&fit=crop&fm=jpg&w=1920');">
						<div class="titan-caption">
							<div class="caption-content">
								<div class="font-alt mb-30 titan-title-size-1">Notre objectif principal</div>
								<div class="font-alt mb-40 titan-title-size-3">Vous rendre <i>meilleur</i></div>
								<a class="section-scroll btn btn-border-w btn-round" href="#" data-toggle="modal" data-target="#menteeFormModal">Inscrivez-vous</a>
							</div>
						</div>
					</li>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
							<h2 class="module-title font-alt">Nos domaines d'expertise</h2>
							<div class="module-subtitle font-serif">Découvrez les domaines dans lesquels nous vous permettrons de devenir meilleur</div>
						</div>
					</div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="video-box">
                ...
                <div class="video-title font-alt">Découvrez nous en vidéo</div>
                <div class="video-subtitle font-alt">Ce que nous faisons et pourquoi vous allez nous aimez</div>
              </div>
            </div>
          </div>
        </div>
			...
			<section class="module pb-0" id="works">
				<div class="container">
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
							<h2 class="module-title font-alt">Nos mentors</h2>
				...
				<ul class="works-grid works-grid-gut works-grid-3 works-hover-w" id="works-grid">
					<li class="work-item management webdesign"><a href="portfolio-single-1.html">
					...
					<div class="row">
						<div class="col-sm-6 col-md-8 col-lg-6 col-lg-offset-2">
							<div class="callout-text font-alt">
								<h3 class="callout-title">Vous souhaitez démarrer?</h3>
								<p>Nous avons toujours un mentor disponible pour vous accompagner</p>
							</div>
						</div>
						<div class="col-sm-6 col-md-4 col-lg-2">
							<div class="callout-btn-box"><a class="btn btn-w btn-round" href="portfolio_boxed_gutter_col_3.html">Commencer aujourd'hui</a></div>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="modal-body">
						<div class="flex-container">
							<div class="form-group form-field-inline">
								<label for="gender" class="info-title">Civilité</label>
							...
							<div class="form-group form-field-inline">
								<label for="lastname" class="info-title">Nom</label>
								<div class="input-group">
									<input type="text" class="form-control" id="lastname" name="lastname" placeholder="Votre nom">
								</div>
							</div>
							<div class="form-group form-field-inline">
								<label for="firstname" class="info-title">Prénom.s</label>
								<div class="input-group">
